...
public class TradingPartnerClientTest {
    ...
    void test_createSystem(CustomHostAgentTestData customHostAgentTestData) {
        ...
        request.setName("Arsenii Test 5");
        request.setAlias("Arsenii 5 Alias");
        ...
        tradingPartnerClient.createSystem("82bf48ca067645d08c94b0e8cd7fbd19", request, requestContext);
